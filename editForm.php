...
$sql = "SELECT * FROM complaint_t WHERE complaintID = $formid";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $phoneNo = $row["complaint_phoneNo"];
    $location = $row["complaint_location"];
    $file = $row["complaint_file"];
}
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-11">
                    ...
                    <div class="card">
                        ...
                        <form class="form-horizontal" id="thefrm" enctype="multipart/form-data" name="thefrm" method="post" action="processEdit.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <textarea name="details" rows="3" class="form-control" id="message1" placeholder="Please describe your problem"><?php echo $details; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="phoneNo" class="col-md-6 control-label px-0"><strong>Mobile Phone No
                                        *</strong></label>
                                <div class="col-md-12 px-0">
                                    <input name="phoneNo" type="text" class="form-control" id="tel" value="<?php echo $phoneNo; ?>" placeholder="Enter mobile phone no" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="location" class="col-md-6 control-label px-0"><strong>Problem Location
                                        *</strong></label>
                                <div class="col-md-12 px-0">
                                    <textarea name="location" rows="3" class="form-control" id="hd_location" placeholder="Please describe your problem location" required><?php echo $location; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="my-auto">
                                <input type="hidden" name="complaintID" value="<?php echo $formid; ?>">
                                <a href="helpdesk.php" class="btn btn-light btn-outline-secondary pull-right" role="button" aria-pressed="true">Cancel</a>
                                <button type="submit" name="submit" value="submit" class="btn btn-primary my-0">Submit</button>
                                <button type="submit" name="delete" value="delete" class="btn btn-danger my-0" onclick="goDelete();">Delete</button>
                            </div>
