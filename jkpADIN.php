...
<head>
    <title>CARS (Activity ADIN)</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header class="header-container header80vh">
        <div class="image">
            <img src="imgs/adin/ADINhead.jpg" alt="header-image">
        </div>
        <div class="header-container-info">
            <div class="vertical-center">
                <img class="logo" src="imgs/LogoBackgroundIcon/ADIN Logo.png" alt="logo jkp">
                <p class="logo-name spacing">ADIN</p>
                <p class="logo-desc">
                    We are JKP ADIN. We love to learn and helping those who are in need
                </p>
            </div>
        </div>
    </header>
    ...
    <nav>
        <div class="nav-box-ajwad">
            <div class="navbar-ajwad">
                ...
                <div class="nav-ajwad now"><a href="#">ADIN</a></div>
        ...
        <div class="gray-container">
            <div class="container">
                <?php
                    ...
                    $qry = "SELECT * FROM activity_T WHERE activity_jtk='ADIN' AND activity_status='In Progress'";
