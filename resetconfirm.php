            ...
            <div class="tab-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        ...
                        <h2 style="text-align: justify;">A verification code has been sent to your email!</h2>
                        <div class="wrapper">
                            <div class="dialog">
                                ...
                                <form method="post" action="securitysettings.php" class="card mt-4">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <div>
                                            <h3>Please enter the 4-digit verification code we sent via Email to <?php echo $email; ?>:</h3>
                                        </div>
                                        <?php
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" name="verifyCode" class="btn btn-primary" value="Verify"></input>

                                        <div class="mt-2 small">
                                            Didn't receive the code?<br />
                                            <a href="#">Send code again</a><br />
                                            <a href="resetreq.php">Change email</a>
                                        </div>
                                    </div>
