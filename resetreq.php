...
<head>
    ...
    <title>CARS (Password Recovery)</title>
                ...
                <div class="col-lg-8 col-md-10">
                    <div class="header-container">
                        <a href="javascript:self.history.back();">
                            <img src="imgs/icons/BackBTN2.svg" alt="back" class="back-button">
                        </a>
                    ...
                    <ol class="list-unstyled">
                        ...
                        <li><span class="text-primary text-medium">2. </span>Answer the security question prompted.</li>
                        <li><span class="text-primary text-medium">3. </span>We'll email you a temporary code.</li>
                        <li><span class="text-primary text-medium">4. </span>Use the code to change your password on our
                            secure website.</li>
                    </ol>
                    <form method="post" action="securitysettings.php" class="card mt-4">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                if ($action == "incorrect_email") {
                                ?>
                                    <div class="alert alert-danger alert-dismissible" role="alert">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        Sorry, the email you entered was invalid. Please try again
                                    </div>
                                <?php
                                }
                                ?>
                                <input class="form-control" name="email" type="email" id="email-for-pass" required=""><small class="form-text text-muted">Type in the email address you used when you registered
                                    with CARS. Then we'll email a code to this address.</small>
                            </div>
                        </div>
                        <div class="card-footer">
                            <input type="submit" name="verifyEmail" class="btn btn-primary" value="Verify"></input>
                        </div>
                    </form>
                </div>
            </div>
