...
<head>
    <title>CARS (Activity SUKAN)</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header class="header-container header80vh">
        <div class="image">
            <img src="imgs/sukeria/SUKRIAhead.jpg" alt="header-image">
        </div>
        <div class="header-container-info">
            <div class="vertical-center">
                <img class="logo" src="imgs/LogoBackgroundIcon/SUKAN Logo.png" alt="logo jkp">
                <p class="logo-name spacing">SUKAN</p>
                <p class="logo-desc">
                    We are JKP SUKAN. We love sports. We have a have a lot of activity coming up and hope you all will
                    enter!
                </p>
            </div>
        </div>
    ...
    <nav>
        <div class="nav-box-ajwad">
            <div class="navbar-ajwad">
                ...
                <div class="nav-ajwad now"><a href="#">SUKAN</a></div>
            </div>
        </div>
    </nav>
        ...
        <div class="gray-container">
            <div class="container">
                <?php
                    ...
                    $qry = "SELECT * FROM activity_T WHERE activity_jtk='SUKAN' AND activity_status='In Progress'";
