...
if ($action == "deleted_acc") {
    //  Unsetting the registered session variables.
    session_unset();
    $_SESSION = array();
...
<head>
    <title>CARS (Deleted Account)</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <main>
        ...
        if ($action == "deleted_acc") {
            ...
            <div class="containerAct">
                ...
                <div class="modal-box complete">
                    <h2>Your account has been removed successfully</h2>
                    <p>We hope to see you again!</p>
                    <br>
                    <button id="profile_page" class="btn btn-primary" onclick="window.location.href=\'home.php\'">Return to Home Page</button>
                </div>
            </div>
        </div>
            ';
        ...
        if ($_SERVER['REQUEST_URI'] == '/files/processLogout.php') {
            echo '
            <div class="mainContainer">
                <div class="containerAct">
                <br><br><br><br><br><br><br><br>
                    ...
                    <div class="modal-box complete">
                        ...
                        Invalid access. Please click the Log Out button to log out.</div>
                    </div>
                </div>
            </div>
            ';
