...
<head>
    <title>CARS (Activity SENI)</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header class="header-container header80vh">
        <div class="image">
            <img src="imgs/kreative/KREATIVEhead.jpg" alt="header-image">
        </div>
        <div class="header-container-info">
            <div class="vertical-center">
                <img class="logo" src="imgs/LogoBackgroundIcon/SENI Logo.png" alt="logo jkp">
                <p class="logo-name" style="letter-spacing: 0.5em;">SENI</p>
                <p class="logo-desc">
                    We are JKP SENI. Like doing something fun and creative? Well we do too! Let's be creative together!
                </p>
            </div>
        </div>
    </header>
    ...
    <nav>
        <div class="nav-box-ajwad">
            <div class="navbar-ajwad">
                ...
                <div class="nav-ajwad now"><a href="#">SENI</a></div>
        ...
        <div class="gray-container">
            <div class="container">
                <?php
                    ...
                    $qry = "SELECT * FROM activity_T WHERE activity_jtk='SENI' AND activity_status='In Progress'";
