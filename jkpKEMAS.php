...
<head>
    <title>CARS (Activity KEMAS)</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header class="header-container header80vh">
        <div class="image">
            <img src="imgs/kemas/KEMAShead.jpg" alt="header-image">
        </div>
        <div class="header-container-info">
            <div class="vertical-center">
                <img class="logo" src="imgs/LogoBackgroundIcon/KEMAS Logo.png" alt="logo jkp">
                <p class="logo-name spacing">KEMAS</p>
                <p class="logo-desc">
                    We are JKP KEMAS. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore, quo quas eaque
                    ut culpa, quasi ipsam non quis earum, doloribus voluptatibus quos corrupti deleniti consequatur!
                </p>
            </div>
        </div>
    </header>
    ...
    <nav>
        <div class="nav-box-ajwad">
            <div class="navbar-ajwad">
                ...
                <div class="nav-ajwad now"><a href="#">KEMAS</a></div>
        ...
        <div class="gray-container">
            <div class="container">
                <?php
                    ...
                    $qry = "SELECT * FROM activity_T WHERE activity_jtk='KEMAS' AND activity_status='In Progress'";
